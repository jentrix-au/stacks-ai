...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('TASK_CREATED', 'TASK_UPDATED', 'TASK_MOVED', 'TASK_ARCHIVED', 'TASK_RESTORED', 'LABEL_ADDED', 'LABEL_REMOVED', 'ASSIGNEE_ADDED', 'ASSIGNEE_REMOVED', 'DUE_DATE_SET', 'DUE_DATE_CLEARED', 'PRIORITY_CHANGED', 'COMMENT_CREATED', 'COMMENT_EDITED', 'COMMENT_DELETED', 'ATTACHMENT_ADDED', 'ATTACHMENT_REMOVED', 'SUBTASK_ADDED', 'SUBTASK_COMPLETED');
